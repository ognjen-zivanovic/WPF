...
namespace HotelRezervacije
{
    ...
    public partial class KarticaSobeKorisnik : UserControl
    {
        ...
        {
            var checkoutWindow = new ProzorPorudzbineKorisnik(SobaId, DatumDolaska, DatumOdlaska, UkupnaCena, BrojGostiju, BrojBeba, string.Join(", ", Pogodnosti.Select(a => a.Ime)));
            checkoutWindow.Show();
        }
    }
}